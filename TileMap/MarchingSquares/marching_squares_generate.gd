...
static func generate_collision_shapes(
	...
	var x_viewport_tiles := floori(viewport_rect.size.x/MarchingSquaresUtility.TILE_SIZE) - 1;
	var y_viewport_tiles := floori(viewport_rect.size.y/MarchingSquaresUtility.TILE_SIZE) - 1;
