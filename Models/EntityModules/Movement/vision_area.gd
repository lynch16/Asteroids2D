...
extends Area2D
## Tracks what a Character can see
...
func _draw_vision_cone() -> void:
	var cone_color := Color(1, 0, 0, 0.1) if has_visible_objects() else Color(0, 1, 0, 0.1)
